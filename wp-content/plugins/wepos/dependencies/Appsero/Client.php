...
/**
 * WeDevs\WePOS\Dependencies\Appsero Client
 *
...
class Client {
     ...
     *
     * @return WeDevs\WePOS\Dependencies\Appsero\Insights
     */
    ...
    public function updater() {
        ...
        _deprecated_function( __CLASS__ . '::updater', '2.0', '\WeDevs\WePOS\Dependencies\Appsero\Updater::init($client);, for more details please visit: https://appsero.com/docs/appsero-developers-guide/appsero-client/appsero-sdk-updater-changes/' );

        // initialize the new updater
        if ( method_exists( '\WeDevs\WePOS\Dependencies\Appsero\Updater', 'init' ) ) {
            \WeDevs\WePOS\Dependencies\Appsero\Updater::init( $this );
        }
    }
     ...
     *
     * @return WeDevs\WePOS\Dependencies\Appsero\License
     */
